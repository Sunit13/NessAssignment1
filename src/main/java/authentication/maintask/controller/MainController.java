...
public class MainController {
	...
	public ResponseEntity<String> getDirectory(@RequestHeader("Authorization") String token){
	...
	public ResponseEntity<String> getFileInformation(@RequestHeader("Authorization") String token){
		if(token == null || !token.startsWith("Bearer")) {
			return new ResponseEntity<String>("Authorization header is not valid ", HttpStatus.UNAUTHORIZED);
		}
...
//	public String changeDirectory(@RequestHeader("Authorization") String token, String directory) {
//		return authservice.ChangeDirectory(token, directory);
//	}
